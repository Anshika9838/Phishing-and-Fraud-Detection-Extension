<p align="center">
  <img src="docs/logo/logo.png" alt="Theft Alert Logo" width="100"/>
</p>

<h1 align="center">Theft Alert</h1>
<p align="center">
  <strong>Open Source Cyber Theft Analysis API Gateway</strong>
</p>

<p align="center">
  <a href="#1-executive-summary">Summary</a> •
  <a href="#2-system-architecture">Architecture</a> •
  <a href="#3-detailed-workflow-the-request-lifecycle">Workflow</a> •
  <a href="#4-feature-deep-dive">Features</a> •
  <a href="#5-data-management--privacy">Data & Privacy</a> •
  <a href="#6-technical-specifications">Specs</a> •
  <a href="#7-client-side-specification-inferred-for-browser-extension">Contributing</a>
</p>
...
## Client-Side Specification (Browser Extension)
...
### Required Permissions (Manifest V3 Example)
...
**Theft Alert** – Advanced Phishing & Fraud Detection System
